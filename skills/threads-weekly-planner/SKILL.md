...
2. **Если находишься в проектной папке** `~/Documents/Вайб-кодинг/threads-content/` — прочитай все `.md` файлы как контекст:
   - `audience.md` — целевая аудитория, боли, запросы
   - `best-practices.md` — как писать цепляющие threads
   - `examples.md` — примеры хороших постов
   - `rules.md` — правила контента и стиль
   - `history.md` — опубликованные посты (полный текст)
   - `headlines.md` — опубликованные заголовки (для проверки уникальности)
3. **Если НЕ в проектной папке** — прочитай историю: `~/claude-config/skills/threads-weekly-planner/history.md`
4. Определи текущую дату и рассчитай даты для постов:
...
После успешной публикации всех постов обнови историю:
- **Если в проектной папке** — обнови `~/Documents/Вайб-кодинг/threads-content/history.md` (полные тексты) и `~/Documents/Вайб-кодинг/threads-content/headlines.md` (заголовки)
- **Если НЕ в проектной папке** — обнови `~/claude-config/skills/threads-weekly-planner/history.md`
- Добавь все запланированные посты с датами
- Формат записи для `history.md`:
...
Формат записи для `headlines.md` (если в проектной папке):
```
